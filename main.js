...
mymodel=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/6yrdOQDQm/model.json',modelLoaded);
function modelLoaded(){
    console.log("The Model is Loaded")
}
function speak(){
    keepapi=window.speechSynthesis;
    speak1="I guess you feel "+emotionname1
    speak2="or I guess you feel "+emotionname2
